...
button.textContent = "اشتري الان";
button.classList.add("btn-changing");
overlay.appendChild(button);

section.appendChild(overlay);

const elFeatures = document.querySelector(".image-text");
if (elFeatures) {
    elFeatures.parentNode.insertBefore(section, elFeatures);
} else {
    console.error('Element with class "el_features" not found.');
}
